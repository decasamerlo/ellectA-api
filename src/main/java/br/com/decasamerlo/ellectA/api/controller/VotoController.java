...
public class VotoController {
	...
	@GetMapping
	public List<Voto> listar(@RequestParam(required=false, defaultValue="") String idProtocolo) {
		if (!idProtocolo.isEmpty()) {
			return votoRepository.findByProtocoloId(Long.parseLong(idProtocolo));
		}
